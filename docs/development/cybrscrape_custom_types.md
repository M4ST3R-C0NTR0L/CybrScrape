# Using CybrScrape's custom types

> You can take advantage of the custom-made types for CybrScrape and use them outside the library if you want. It's better than copying their code, after all :)

### All current types can be imported alone, like below
```python
>>> from cybrscrape.core.custom_types import TextHandler, AttributesHandler
