# CybrScrape Interactive Shell Guide
...
The CybrScrape Interactive Shell is an enhanced IPython-based environment designed specifically for Web Scraping tasks. It provides instant access to all CybrScrape features, clever shortcuts, automatic page management, and advanced tools, such as conversion of the curl command.
...
- **Learning CybrScrape**: Experiment with features in real-time
...
cybrscrape shell -c "get('https://quotes.toscrape.com'); print(len(page.css('.quote')))"

# Set logging level
cybrscrape shell --loglevel info
```

Once launched, you'll see the CybrScrape banner and can immediately start scraping as the video above shows:
...
<img src="../assets/cybrscrape_shell_curl.png" title="Copying a request as a curl command from Chrome" alt="Copying a request as a curl command from Chrome" style="width: 70%;"/>

- **Convert Curl command to Request Object**

    ```python
    >>> curl_cmd = '''curl 'https://cybrscrape.requestcatcher.com/post' \
    ...   -X POST \
    ...
    'post'
    >>> request.url
    'https://cybrscrape.requestcatcher.com/post'
    >>> request.headers
...
- [CybrScrape Documentation](https://cybrscrape.readthedocs.io/)
- [Discord Community](https://discord.gg/EMgGbDceNQ)
- [GitHub Issues](https://github.com/D4Vinci/CybrScrape/issues)  
