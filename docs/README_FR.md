...
<p align="center">
    <a href="https://cybrscrape.readthedocs.io/en/latest/parsing/selection.html"><strong>Méthodes de sélection</strong></a>
    &middot;
    ...
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/spiders/proxy-blocking.html"><strong>Rotation de proxy</strong></a>
    &middot;
...
CybrScrape est un framework de Web Scraping adaptatif qui gère tout, d'une simple requête à un crawl à grande échelle.
...
<table>
  <tr>
    ...
    <td> CybrScrape gère Cloudflare Turnstile. Pour une protection de niveau entreprise, <a href="https://hypersolutions.co?utm_source=github&utm_medium=readme&utm_campaign=cybrscrape">
        <b>Hyper Solutions</b>
  ...
  <tr>
    ...
    <td>Nous avons créé <a href="https://birdproxies.com/t/cybrscrape">
        <b>BirdProxies</b>
  ...
  <tr>
    ...
    <td>
      <a href="https://tikhub.io/?ref=Cybrflux" target="_blank">TikHub.io</a> propose plus de 900 APIs stables sur plus de 16 plateformes, dont TikTok, X, YouTube et Instagram, avec plus de 40M de jeux de données. <br /> Propose également des <a href="https://ai.tikhub.io/?ref=Cybrflux" target="_blank">modèles IA à prix réduit</a> — Claude, GPT, GEMINI et plus, jusqu'à 71% de réduction.
    </td>
  </tr>
  <tr>
    <td width="200">
  ...
  <tr>
    ...
    <a href="https://petrosky.io/cybrflux" target="_blank">PetroSky VPS</a> - des serveurs cloud conçus pour l'automatisation sans interruption. Machines Windows et Linux avec contrôle total. À partir de 6,99 €/mois.
    </td>
  </tr>
  <tr>
    <td width="200">
    ...
    <td>
    Lisez une critique complète de <a href="https://substack.thewebscraping.club/p/cybrscrape-hands-on-guide?utm_source=github&utm_medium=repo&utm_campaign=cybrscrape" target="_blank">CybrScrape sur The Web Scraping Club</a> (nov. 2025), la newsletter n°1 dédiée au Web Scraping.
    </td>
  </tr>
  <tr>
    <td width="200">
...
- 🏗️ **Éprouvé en conditions réelles** : Non seulement CybrScrape dispose d'une couverture de tests de 92% et d'une couverture complète des type hints, mais il est utilisé quotidiennement par des centaines de Web Scrapers depuis l'année dernière.

### Expérience conviviale pour développeurs/Web Scrapers
- 🎯 **Shell interactif de Web Scraping** : Shell IPython intégré optionnel avec intégration CybrScrape, raccourcis et nouveaux outils pour accélérer le développement de scripts de Web Scraping, comme la conversion de requêtes curl en requêtes CybrScrape et l'affichage des résultats dans votre navigateur.
- 🚀 **Utilisez-le directement depuis le terminal** : Optionnellement, vous pouvez utiliser CybrScrape pour scraper une URL sans écrire une seule ligne de code !
...
Voici un aperçu rapide de ce que CybrScrape peut faire sans entrer dans les détails.
...
CybrScrape inclut une interface en ligne de commande puissante :
...
cybrscrape extract get 'https://example.com' content.txt --css-selector '#fromSkipToProducts' --impersonate 'chrome'  # Tous les éléments correspondant au sélecteur CSS '#fromSkipToProducts'
...
> [!NOTE]
> Il existe de nombreuses fonctionnalités supplémentaires, mais nous souhaitons garder cette page concise, y compris le serveur MCP et le shell interactif de Web Scraping. Consultez la documentation complète [ici](https://cybrscrape.readthedocs.io/en/latest/)

## Benchmarks de performance

CybrScrape n'est pas seulement puissant — il est aussi ultra rapide. Les benchmarks suivants comparent le parser de CybrScrape avec les dernières versions d'autres bibliothèques populaires.

### Test de vitesse d'extraction de texte (5000 éléments imbriqués)

| # |   Bibliothèque    | Temps (ms) | vs CybrScrape |
|---|:-----------------:|:----------:|:------------:|
...
Les capacités adaptatives de recherche d'éléments de CybrScrape surpassent significativement les alternatives :
...
> Tous les benchmarks représentent des moyennes de plus de 100 exécutions. Voir [benchmarks.py](https://github.com/D4Vinci/CybrScrape/blob/main/benchmarks.py) pour la méthodologie.

## Installation

CybrScrape nécessite Python 3.10 ou supérieur :
...
1. Si vous allez utiliser l'une des fonctionnalités supplémentaires ci-dessous, les fetchers ou leurs classes, vous devrez installer les dépendances des fetchers et leurs dépendances navigateur comme suit :
    ...
    cybrscrape install           # installation normale
    cybrscrape install  --force  # réinstallation forcée
    ```
...
2. Fonctionnalités supplémentaires :
   ...
   - Tout installer :
       ...
       ```
   N'oubliez pas que vous devez installer les dépendances navigateur avec `cybrscrape install` après l'un de ces extras (si vous ne l'avez pas déjà fait)
...
Les contributions sont les bienvenues ! Veuillez lire nos [directives de contribution](https://github.com/D4Vinci/CybrScrape/blob/main/CONTRIBUTING.md) avant de commencer.
...
- Parsel (Licence BSD) — Utilisé pour le sous-module [translator](https://github.com/D4Vinci/CybrScrape/blob/main/cybrscrape/core/translator.py)
