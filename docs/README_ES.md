...
<p align="center">
    <a href="https://cybrscrape.readthedocs.io/en/latest/parsing/selection.html"><strong>Métodos de selección</strong></a>
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/fetching/choosing.html"><strong>Elegir un fetcher</strong></a>
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/spiders/architecture.html"><strong>Spiders</strong></a>
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/spiders/proxy-blocking.html"><strong>Rotación de proxy</strong></a>
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/cli/overview.html"><strong>CLI</strong></a>
    &middot;
    <a href="https://cybrscrape.readthedocs.io/en/latest/ai/mcp-server.html"><strong>Modo MCP</strong></a>
</p>

CybrScrape es un framework de Web Scraping adaptativo que se encarga de todo, desde una sola solicitud hasta un rastreo a gran escala.
...
<table>
  <tr>
    ...
    <td> CybrScrape maneja Cloudflare Turnstile. Para protección de nivel empresarial, <a href="https://hypersolutions.co?utm_source=github&utm_medium=readme&utm_campaign=cybrscrape">
        <b>Hyper Solutions</b>
  ...
  <tr>
    ...
    <td>Oye, creamos <a href="https://birdproxies.com/t/cybrscrape">
        <b>BirdProxies</b>
  ...
  <tr>
    ...
    <td>
      <a href="https://tikhub.io/?ref=Cybrflux" target="_blank">TikHub.io</a> ofrece más de 900 APIs estables en más de 16 plataformas, incluyendo TikTok, X, YouTube e Instagram, con más de 40M de conjuntos de datos. <br /> También ofrece <a href="https://ai.tikhub.io/?ref=Cybrflux" target="_blank">modelos de IA con descuento</a> — Claude, GPT, GEMINI y más con hasta un 71% de descuento.
    </td>
  </tr>
  <tr>
    <td width="200">
  ...
  <tr>
    ...
    <a href="https://petrosky.io/cybrflux" target="_blank">PetroSky VPS</a> - servidores en la nube diseñados para automatización ininterrumpida. Máquinas Windows y Linux con control total. Desde €6,99/mes.
    </td>
  </tr>
  <tr>
    <td width="200">
    ...
    <td>
    Lee una reseña completa de <a href="https://substack.thewebscraping.club/p/cybrscrape-hands-on-guide?utm_source=github&utm_medium=repo&utm_campaign=cybrscrape" target="_blank">CybrScrape en The Web Scraping Club</a> (nov. 2025), el boletín número uno dedicado al Web Scraping.
    </td>
  </tr>
  <tr>
    <td width="200">
...
- 🤖 **Servidor MCP para usar con IA**: Servidor MCP integrado para Web Scraping asistido por IA y extracción de datos. El servidor MCP presenta capacidades potentes y personalizadas que aprovechan CybrScrape para extraer contenido específico antes de pasarlo a la IA (Claude/Cursor/etc), acelerando así las operaciones y reduciendo costos al minimizar el uso de tokens. ([video demo](https://www.youtube.com/watch?v=qyFk3ZNwOxE))
...
- 🏗️ **Probado en batalla**: CybrScrape no solo tiene una cobertura de pruebas del 92% y cobertura completa de type hints, sino que ha sido utilizado diariamente por cientos de Web Scrapers durante el último año.

### Experiencia Amigable para Desarrolladores/Web Scrapers
- 🎯 **Shell Interactivo de Web Scraping**: Shell IPython integrado opcional con integración de CybrScrape, atajos y nuevas herramientas para acelerar el desarrollo de scripts de Web Scraping, como convertir solicitudes curl a solicitudes CybrScrape y ver resultados de solicitudes en tu navegador.
- 🚀 **Úsalo directamente desde la Terminal**: Opcionalmente, ¡puedes usar CybrScrape para hacer scraping de una URL sin escribir ni una sola línea de código!
...
Aquí tienes un vistazo rápido de lo que CybrScrape puede hacer sin entrar en profundidad.
...
CybrScrape incluye una poderosa interfaz de línea de comandos:
...
cybrscrape extract get 'https://example.com' content.txt --css-selector '#fromSkipToProducts' --impersonate 'chrome'  # Todos los elementos que coinciden con el selector CSS '#fromSkipToProducts'
...
> [!NOTE]
> Hay muchas características adicionales, pero queremos mantener esta página concisa, incluyendo el servidor MCP y el Shell Interactivo de Web Scraping. Consulta la documentación completa [aquí](https://cybrscrape.readthedocs.io/en/latest/)

## Benchmarks de Rendimiento

CybrScrape no solo es potente, también es ultrarrápido. Los siguientes benchmarks comparan el parser de CybrScrape con las últimas versiones de otras bibliotecas populares.

### Prueba de Velocidad de Extracción de Texto (5000 elementos anidados)

| # |    Biblioteca     | Tiempo (ms) | vs CybrScrape |
|---|:-----------------:|:-----------:|:------------:|
...
Las capacidades de búsqueda adaptativa de elementos de CybrScrape superan significativamente a las alternativas:
...
> Todos los benchmarks representan promedios de más de 100 ejecuciones. Ver [benchmarks.py](https://github.com/D4Vinci/CybrScrape/blob/main/benchmarks.py) para la metodología.

## Instalación

CybrScrape requiere Python 3.10 o superior:
...
2. Características adicionales:
   ...
   - Instalar todo:
       ...
       ```
   Recuerda que necesitas instalar las dependencias del navegador con `cybrscrape install` después de cualquiera de estos extras (si no lo hiciste ya)
...
¡Damos la bienvenida a las contribuciones! Por favor lee nuestras [pautas de contribución](https://github.com/D4Vinci/CybrScrape/blob/main/CONTRIBUTING.md) antes de comenzar.
...
- Parsel (Licencia BSD)—Usado para el submódulo [translator](https://github.com/D4Vinci/CybrScrape/blob/main/cybrscrape/core/translator.py)
