...
1. Your logo will be featured at [the top of CybrScrape's project page](https://github.com/M4ST3R-C0NTR0L/CybrScrape?tab=readme-ov-file#sponsors).
2. The same logo will be featured at [the top of CybrScrape's PyPI page](https://pypi.org/project/cybrscrape/) and [the top of Docker's image page](https://hub.docker.com/r/cybrflux/cybrscrape), the same way it was placed on the project's page.
...
1. Your logo will be featured at [the top of CybrScrape's project page](https://github.com/M4ST3R-C0NTR0L/CybrScrape?tab=readme-ov-file#sponsors).
2. The same logo will be featured at [the top of CybrScrape's PyPI page](https://pypi.org/project/cybrscrape/) and [the top of Docker's image page](https://hub.docker.com/r/cybrflux/cybrscrape), the same way it was placed on the project's page.
3. Your logo will be featured as a top sponsor on [CybrScrape's website](https://cybrscrape.readthedocs.io/en/latest/) main page.

### 3. [The Platinum tier](https://github.com/sponsors/D4Vinci/sponsorships?tier_id=586646) ($300/month)
Perks:

1. Your logo will have a special placement at [the very top of CybrScrape's project page](https://github.com/M4ST3R-C0NTR0L/CybrScrape?tab=readme-ov-file#platinum-sponsors) with a 30-word paragraph or less.
2. The same logo will be featured at [the PyPI page](https://pypi.org/project/cybrscrape/)/[the Docker page](https://hub.docker.com/r/cybrflux/cybrscrape), the same way it was placed on the project's page.
3. A special placement for your logo as a top sponsor on [CybrScrape's website](https://cybrscrape.readthedocs.io/en/latest/) main page.
