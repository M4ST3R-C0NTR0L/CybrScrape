...
from cybrscrape.core.custom_types import MappingProxyType
from cybrscrape.parser import Selector, SQLiteStorageSystem

if TYPE_CHECKING:
    from cybrscrape.spiders import Request
