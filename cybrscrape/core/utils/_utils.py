...
from cybrscrape.core._types import Any, Dict, Iterable, List
...
def setup_logger():
    ...
    """
    logger = logging.getLogger("cybrscrape")
...
_current_logger: ContextVar[logging.Logger] = ContextVar("cybrscrape_logger", default=setup_logger())
