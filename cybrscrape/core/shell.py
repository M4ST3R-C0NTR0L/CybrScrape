...
from cybrscrape import __version__
from cybrscrape.core.utils import log
from cybrscrape.parser import Selector, Selectors
from cybrscrape.core.custom_types import TextHandler
from cybrscrape.engines.toolbelt.custom import Response
from cybrscrape.core.utils._shell import _ParseHeaders, _CookieParser
...
class CurlParser:
    ...
    def __init__(self) -> None:
        from cybrscrape.fetchers import Fetcher as __Fetcher
...
def show_page_in_browser(page: Selector):  # pragma: no cover
    ...
    try:
        fd, fname = make_temp_file(prefix="cybrscrape_view_", suffix=".html")
...
class CustomShell:
    ...
    def init_components(self):
        ...
        if self.log_level:
            getLogger("cybrscrape").setLevel(self.log_level)
