...
from cybrscrape.spiders.engine import CrawlerEngine
from cybrscrape.spiders.session import SessionManager
from cybrscrape.core.utils import set_logger, reset_logger
from cybrscrape.spiders.result import CrawlResult, CrawlStats
from cybrscrape.core._types import Set, Any, Dict, Optional, Union, TYPE_CHECKING, AsyncGenerator
...
class Spider(ABC):
    ...
    def __init__(self, crawldir: Optional[Union[str, Path, AsyncPath]] = None, interval: float = 300.0):
        ...
        self.logger = logging.getLogger(f"cybrscrape.spiders.{self.name}")
        self.logger.setLevel(self.logging_level)
        self.logger.handlers.clear()
        self.logger.propagate = False  # Don't propagate to parent 'cybrscrape' logger
