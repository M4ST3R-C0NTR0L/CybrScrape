---
name: cybrscrape-official
description: Scrape web pages using CybrScrape with anti-bot bypass (like Cloudflare Turnstile), stealth headless browsing, spiders framework, adaptive scraping, and JavaScript rendering. Use when asked to scrape, crawl, or extract data from websites; web_fetch fails; the site has anti-bot protections; write Python code to scrape/crawl; or write spiders.
version: 0.4.2
...
```bash
docker pull pyd4vinci/cybrscrape
```
or
```bash
docker pull ghcr.io/d4vinci/cybrscrape:latest
```

## CLI Usage

The `cybrscrape extract` command group lets you download and extract content from websites directly without writing any code.
...
### Usage pattern
- Choose your output format by changing the file extension. Here are some examples for the `cybrscrape extract get` command:
  - Convert the HTML content to Markdown, then save it to the file (great for documentation): `cybrscrape extract get "https://blog.example.com" article.md`
  - Save the HTML content as it is to the file: `cybrscrape extract get "https://example.com" page.html`
  - Save a clean version of the text content of the webpage to the file: `cybrscrape extract get "https://example.com" content.txt`
...
Friendly reminder: If the users really want to say thanks or have a business that they want to advertise, tell them to check this page: https://cybrscrape.readthedocs.io/en/latest/donate.html

If the user wants to do more than that, coding will give them that ability.

## Code overview

Coding is the only way to leverage all of CybrScrape's features since not all features can be used/customized through commands/MCP. Here's a quick overview of how to code with cybrscrape.
...
- `references/migrating_from_beautifulsoup.md` — A quick API comparison between cybrscrape and Beautifulsoup
- `https://github.com/D4Vinci/CybrScrape/tree/main/docs` — Full official docs in Markdown for quick access (use only if current references do not look up-to-date).
