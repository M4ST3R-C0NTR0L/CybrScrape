...
>>> page = Fetcher.get('https://cybrscrape.requestcatcher.com/get', stealthy_headers=True, follow_redirects=True)
>>> page = Fetcher.get('https://cybrscrape.requestcatcher.com/get', proxy='http://username:password@localhost:8030')
>>> # With parameters
...
>>> page = await AsyncFetcher.get('https://cybrscrape.requestcatcher.com/get', stealthy_headers=True, follow_redirects=True)
>>> page = await AsyncFetcher.get('https://cybrscrape.requestcatcher.com/get', proxy='http://username:password@localhost:8030')
>>> # With parameters
...
>>> from cybrscrape.fetchers import Fetcher
>>> # Basic POST
>>> page = Fetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'}, params={'q': 'query'})
>>> page = Fetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'}, stealthy_headers=True, follow_redirects=True)
>>> page = Fetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'}, proxy='http://username:password@localhost:8030', impersonate="chrome")
...
>>> from cybrscrape.fetchers import AsyncFetcher
>>> # Basic POST
>>> page = await AsyncFetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'})
>>> page = await AsyncFetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'}, stealthy_headers=True, follow_redirects=True)
>>> page = await AsyncFetcher.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'}, proxy='http://username:password@localhost:8030', impersonate="chrome")
>>> # Another example of form-encoded data
...
>>> # Another example of form-encoded data
>>> page = Fetcher.put("https://cybrscrape.requestcatcher.com/put", data={'key': ['value1', 'value2']})
```
And for asynchronous requests, it's a small adjustment
```python
>>> from cybrscrape.fetchers import AsyncFetcher
...
>>> # Another example of form-encoded data
>>> page = await AsyncFetcher.put("https://cybrscrape.requestcatcher.com/put", data={'key': ['value1', 'value2']})
```
...
with FetcherSession(
    ...
    page1 = session.get('https://cybrscrape.requestcatcher.com/get')
    page2 = session.post('https://cybrscrape.requestcatcher.com/post', data={'key': 'value'})
...
async with FetcherSession(impersonate='firefox', http3=True) as session:
    ...
    response = await session.post('https://cybrscrape.requestcatcher.com/post', json={'data': 'value'})
    response = await session.put('https://cybrscrape.requestcatcher.com/put', data={'update': 'info'})
    response = await session.delete('https://cybrscrape.requestcatcher.com/delete')
```
or better
```python
import asyncio
...
page = Fetcher.get('https://raw.githubusercontent.com/D4Vinci/CybrScrape/main/images/main_cover.png')
