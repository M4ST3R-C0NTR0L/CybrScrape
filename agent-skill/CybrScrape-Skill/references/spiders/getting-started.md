...
The `parse()` method processes each response. You use the same selection methods you'd use with CybrScrape's [Selector](parsing/main_classes.md#selector)/[Response](fetching/choosing.md#response-object), and `yield` dictionaries to output scraped items.
